...
containsRange (Range start1 end1) (Range start2 end2) = 
  start1 <= start2 && end2 <= end1
      
contains :: Cuboid -> Cuboid -> Bool
contains (Cuboid ranges1) (Cuboid ranges2) = 
  and (zipWith containsRange ranges1 ranges2)
...
subtract base_cuboid subtract_cuboid
  | overlapVolume base_cuboid subtract_cuboid == 0 = [base_cuboid]
  | otherwise = remaining_sub_cuboids
  where
    ...
    remaining_sub_cuboids = 
      ...
      $ zip [0..] (getRanges subtract_cuboid)
